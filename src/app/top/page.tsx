        ...
        <Box width="60%" height="100%" mb="16">
          <Flex direction="column">
            ...
            {posts?.map((post: any) => {
              ...
              <Box height="300" borderRadius="20" background="orange.100" border="2px" borderColor="orange.500" mt="5" key={post.id}>
              <Flex>
                ...
                <Box width="50%" height="250" mr="5" mt="5">
                  <Flex direction="column">
                    ...
                    <Box height="6" display="flex" alignItems="center" justifyContent="space-between" ml="1" mr="1" mt="1">
                      ...
                      {/* Editボタン */}
                      <button onClick={() => {linkToEdit(post.id)}}>
                        <FontAwesomeIcon icon={faPenToSquare} size="lg" color="#4299E1"/>
                      </button>
                      {/* Editボタン */}

                      {/* 削除ボタン */}
                      <button onClick={() => {clickDelete(post.id)}}>
